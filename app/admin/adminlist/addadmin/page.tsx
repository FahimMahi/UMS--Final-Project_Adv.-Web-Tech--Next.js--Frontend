...
export default function AddAdmin() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:3000/admin/createadminaccount', formDataObject);
            ...
            console.error('Error during Add Admin:', error);
  ...
  return (
    <div className="max-w-md mx-auto mt-8 bg-gray-800 p-6 rounded-lg shadow-lg">
        <center><h1 className="text-3xl font-bold text-white mb-6">Add Admin</h1></center>
        <Toaster />
